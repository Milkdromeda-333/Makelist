...
export default function LogoutModal({ setNavbarOptionsModalData, setUser }) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="center-col gap-4 text-2xl">
                    <p>Are you sure you want to log out?</p>

                    <div className="center-row gap-2 text-white">
                        <button onClick={logout} className="py-1 px-3 bg-green-500 ring-white hover:ring-2">Yes</button>
